...
# data = genfromtxt('bench_result_plot_22.csv', delimiter=',')
# # data = genfromtxt('bench_result_plot_4.csv', delimiter=',')
...
# # csv_out = open('bench_22_states_np.csv', 'wb')
# csv_out = open('bench_4_states_np.csv', 'wb')
