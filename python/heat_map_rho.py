...
for shapedict in m.states_info:
    ...
    if statename in include: #not in exclusions: #['District of Columbia','Puerto Rico']:
        ...
        # color_value = 1.-np.sqrt((rhos-vmin)/(vmax-vmin))
        color_value = (rhos-rho_min)/(rho_max-rho_min)
...
re_color = np.array(color_values) * (rho_max-rho_min)  + rho_min
